...
void display(void){
	...
	{//endgame screen: score display
		...
		renderBitmapString(35,60,0,GLUT_BITMAP_HELVETICA_18,"-Wear mask at all the times");
		renderBitmapString(35,55,0,GLUT_BITMAP_HELVETICA_18,"-Maintain social distancing when in a crowd.");
		renderBitmapString(35,50,0,GLUT_BITMAP_HELVETICA_18,"-Always wash your hands before consuming edibles.");
		renderBitmapString(35,45,0,GLUT_BITMAP_HELVETICA_18,"-Cover your mouth when you cough or sneeze.");
		glColor3f(0.0,0.0,0.0);
